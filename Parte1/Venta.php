...
/*
3-
a- (1 pts.) AltaVenta.php: (por POST)
...
class Venta{
    ...
    public function GetFileName(){
        if(!is_null($this)){
            ...
            .'_'. str_replace(" ", "_", $this->nombreHamburguesa) 
            .'_'. $mailRecortado 
    ...
    static public function CountHamburguesaSold($objAD)
    {
        try
        {
            if(!is_null($objAD))
            ...
            echo '¡Ocurrió un Error en function CountHamburguesaSold!, objAD es NULL. Verifique!!' . PHP_EOL;
            return false;
        } 
        catch (PDOException $e) { 
            echo "¡Ocurrió un Error!: ".  $e->getMessage() . PHP_EOL;
